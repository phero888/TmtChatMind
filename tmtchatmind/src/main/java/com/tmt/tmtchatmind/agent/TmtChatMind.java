...
public class TmtChatMind {
    ...
    public TmtChatMind(String agentId,
                       String name,
                       String description,
                       String systemPrompt,
    ...
    private void execute() {
        ...
        //Prompt包含之前的历史记录
        Prompt prompt = Prompt.builder()
                .messages(this.chatMemory.get(this.chatSessionId)) //将历史记录放入
                .chatOptions(this.chatOptions)
                .build();
        //执行工具响应信息
        ...
        //放入执行工具产生的信息
        this.chatMemory.clear(this.chatSessionId);//先清空
        this.chatMemory.add(this.chatSessionId, toolExecutionResult.conversationHistory());//全量更新
