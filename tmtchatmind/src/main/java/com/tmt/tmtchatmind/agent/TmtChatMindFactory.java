package com.tmt.tmtchatmind.agent;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.tmt.tmtchatmind.agent.tools.Tool;
import com.tmt.tmtchatmind.config.ChatClientRegistry;
import com.tmt.tmtchatmind.converter.AgentConverter;
import com.tmt.tmtchatmind.converter.ChatMessageConverter;
import com.tmt.tmtchatmind.converter.KnowledgeBaseConverter;
import com.tmt.tmtchatmind.mapper.AgentMapper;
import com.tmt.tmtchatmind.mapper.KnowledgeBaseMapper;
import com.tmt.tmtchatmind.model.dto.AgentDTO;
import com.tmt.tmtchatmind.model.dto.ChatMessageDTO;
import com.tmt.tmtchatmind.model.dto.KnowledgeBaseDTO;
import com.tmt.tmtchatmind.model.entity.Agent;
import com.tmt.tmtchatmind.model.entity.KnowledgeBase;
import com.tmt.tmtchatmind.service.ChatMessageFacadeService;
import com.tmt.tmtchatmind.service.SseService;
...
@Component
public class TmtChatMindFactory {

    private static final Logger log = LoggerFactory.getLogger(TmtChatMindFactory.class);
    ...
    private TmtChatMind buildAgentRuntime(
            Agent agent,
            List<Message> memory,
     ...
     * 创建一个 JChatMind 实例
     */
    public TmtChatMind create(String agentId, String chatSessionId) {
        ...
        // 解析 agent 支持的工具调用
        List<Tool> runtimeTools = resolveRuntimeTools(agentConfig); //tool是entity -> 前端解析
        // 将工具调用转换成 ToolCallback 的形式
        List<ToolCallback> toolCallbacks = buildToolCallbacks(runtimeTools); //toolcallback是springai提供的 -> ai解析
