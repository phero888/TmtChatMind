...
import com.tmt.tmtchatmind.agent.AgentState;
 ...
 */
@Slf4j
public class TmtChatMindV2 extends TmtChatMindV1 {
    ...
    public TmtChatMindV2() {
        super();
    }
    
    public TmtChatMindV2(String name,
                         String description,
                         String systemPrompt,
    ...
    protected void execute() {
        ...
        // 3. 执行工具调用：toolcall是list，会将list中的所有工具调用完才会返回！！
