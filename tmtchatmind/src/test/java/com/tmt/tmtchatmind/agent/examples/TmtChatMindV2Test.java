package com.tmt.tmtchatmind.agent.examples;

import com.tmt.tmtchatmind.agent.tools.test.CityTool;
import com.tmt.tmtchatmind.agent.tools.test.DateTool;
import com.tmt.tmtchatmind.agent.tools.test.WeatherTool;
 ...
 */
@SpringBootTest
public class TmtChatMindV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        TmtChatMindV2 agent = new TmtChatMindV2(
                "test-agent-v2",
                "测试 Agent V2",
